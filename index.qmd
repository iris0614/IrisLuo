  ...
  <section class="bento" aria-label="Introduction">
    <article class="tile tile-hero">
      ...
      <div class="stat-row">
        ...
        <div class="stat"><b>8</b><span data-i18n="stat_projects">Selected projects</span></div>
      </div>
    </article>
  ...
  <section class="block" id="projects">
    ...
    <div class="project-grid">
      <article class="project-card">
        <div class="project-media is-cover"><img src="img/reading_notes.png" alt=""></div>
        <div class="project-body">
          <h3 data-i18n="p_notes_title">Reading Notes</h3>
          <p data-i18n="p_notes_desc">Magazine-style private reading journal — generous whitespace and staggered cards; open an essay like a long magazine feature.</p>
