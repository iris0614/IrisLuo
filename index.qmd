...
<div class="page-shell">
  <section class="bento" aria-label="Introduction">
    <article class="tile tile-hero">
      <div>
        ...
        <p class="hero-bio" data-i18n="hero_bio">Data scientist with dual master’s degrees in Data Science and Economics. I turn messy data into products teams can use — from cleaning and visualization to modeling and generative AI.</p>
  ...
  <section class="block" id="other">
    ...
    <p class="other-lead lead-line" data-i18n="other_lead">Personal web platforms built for reading archives and investment research, distinct from my data science portfolio.</p>
    <div class="project-grid other-grid">
      <article class="project-card">
        ...
        <div class="project-body">
          ...
          <p data-i18n="p_notes_desc">A magazine-style private reading journal — keep the books you’ve read on paper. Volume 01, seventeen essays.</p>
      ...
      <article class="project-card">
        ...
        <div class="project-body">
          ...
          <p data-i18n="p_zen_desc">A local-only investment journal. Log trades, keep principles, review growth — data stays in the browser, no account required.</p>
